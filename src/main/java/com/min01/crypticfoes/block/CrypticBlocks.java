...
public class CrypticBlocks 
{
    ...
    public static final RegistryObject<BlockEntityType<SkullBlockEntity>> CRYPTIC_SKULL_BLOCK_ENTITY = BLOCK_ENTITIES.register("cryptic_skull", () -> BlockEntityType.Builder.of(SkullBlockEntity::new, CrypticBlocks.HOWLER_HEAD.get(), CrypticBlocks.HOWLER_WALL_HEAD.get()).build(null));
}
